...
export default function RequestDemoComp() {
    return (
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                <div className="pt-32 pb-12 md:pt-40 md:pb-20">
                    ...
                    <div className="max-w-3xl mx-auto text-center pb-12 ">
                        <h1 className="h1 font-bold text-3xl">Welcome! </h1>
                        <p className=" text-gray-400">Do you have Questions?</p>
                    </div>
                            ...
                            <div className="flex flex-wrap -mx-3">
                                <div className="w-full px-3">
                                    <button className="btn px-0 text-white bg-red-600 hover:bg-red-700 w-full relative flex items-center">
                                        ...
                                        <span className="flex-auto pl-16 pr-8 -ml-16 py-3">Sign up with Google</span>
                                    </button>
                                </div>
                            </div>
                        </form> */}
                        ...
                        <form>
                            ...
                            <div className="flex flex-wrap -mx-3 mb-4">
                                <div className="w-full px-3">
                                    ...
                                    <textarea id="message" className="form-input w-full text-gray-300" placeholder="Please enter a message" rows={5} required />
                                </div>
                            </div>
                            ...
                            <div className="flex flex-wrap -mx-3 mt-6">
                                <div className="w-full px-3">
                                    <button className="btn text-white bg-purple-600 hover:bg-purple-700 w-full py-2">Submit</button>
                                </div>
                            </div>
                        </form>
